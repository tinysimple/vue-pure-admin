var ie=Object.defineProperty;var D=Object.getOwnPropertySymbols;var _e=Object.prototype.hasOwnProperty,oe=Object.prototype.propertyIsEnumerable;var j=(e,a,n)=>a in e?ie(e,a,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[a]=n,I=(e,a)=>{for(var n in a||(a={}))_e.call(a,n)&&j(e,n,a[n]);if(D)for(var n of D(a))oe.call(a,n)&&j(e,n,a[n]);return e};var z=(e,a,n)=>new Promise((s,u)=>{var y=t=>{try{m(n.next(t))}catch(b){u(b)}},_=t=>{try{m(n.throw(t))}catch(b){u(b)}},m=t=>t.done?s(t.value):Promise.resolve(t.value).then(y,_);m((n=n.apply(e,a)).next())});import{a as ue}from"./data-CNsUcL2x.js";import{b as se,d as re,gF as le,p as f,t as q,K,ao as de,a1 as O,g as P,o as l,c,O as p,S as L,T as V,au as U,U as G,gG as J,e as M,w,P as C,V as W,a4 as Y,W as F,R as E,b3 as me,aY as ce,aC as ve}from"./index-BbxVbw8z.js";const Q=function(e){let a=Array.isArray(e)?[]:{};if(e&&typeof e=="object")for(let n in e)e.hasOwnProperty(n)&&(e[n]&&typeof e[n]=="object"?a[n]=Q(e[n]):a[n]=e[n]);return a};var g=re({name:"MouseMenu",props:{appendToBody:{type:Boolean,default:!0},menuWidth:{type:Number,default:200},menuList:{type:Array,required:!0},menuHiddenFn:{type:Function},hasIcon:{type:Boolean,default:!1},iconType:{type:String,default:"font-icon"},menuWrapperCss:Object,menuItemCss:Object,el:{type:Object,required:!0},params:{type:[String,Number,Array,Object]},useLongPressInMobile:Boolean,longPressDuration:Number,longPressPreventDefault:[Function,Boolean],injectCloseListener:{type:Boolean,default:!0},customClass:String,disabled:{type:Function}},emits:["open","close"],expose:["show","close","showMenu"],setup(e,{emit:a}){const n=f(0),s=f(0),u=f(!1),y=f(0),_=f(0),m=f(!1),t=f(null),b=f([]),$=q(()=>e.menuList.some(o=>o.children&&o.children.length>0)),T=f(10),S=f();K(m,o=>z(this,null,function*(){var r,d;if(o){yield O();let v=S.value;e.menuWrapperCss&&Object.keys(e.menuWrapperCss).map(h=>{v.style.setProperty(`--menu-${h}`,e.menuWrapperCss&&e.menuWrapperCss[h])}),e.menuItemCss&&Object.keys(e.menuItemCss).map(h=>{v.style.setProperty(`--menu-item-${h}`,e.menuItemCss&&e.menuItemCss[h])});let i=(d=(r=e.menuItemCss)==null?void 0:r.arrowSize)==null?void 0:d.match(/\d+/);i?T.value=~~i[0]||10:T.value=10,v.style.setProperty("--menu-item-arrowRealSize",T.value/2+"px"),a("open",e.params,t.value,e.el)}else a("close",e.params,t.value,e.el)}));const X=(o,r)=>{o.disabled||o.fn&&typeof o.fn=="function"&&o.fn(e.params,t.value,e.el,r)===!1||(m.value=!1)},Z=(o,r)=>{if(!o.disabled){if(o.fn&&typeof o.fn=="function"&&!o.disabled){if(o.fn(e.params,t.value,e.el,r)===!1)return;u.value=!1}m.value=!1}},ee=(o,r)=>z(this,null,function*(){if(r.children&&!r.disabled){u.value=!0,yield O();const d=o.currentTarget;if(!d)return;const{offsetWidth:v}=d,i=d.querySelector(".__menu__sub__wrapper");if(!i)return;const{offsetWidth:h,offsetHeight:k}=i,{innerWidth:ae,innerHeight:R}=window,{top:A,left:H}=d.getBoundingClientRect();H+v+h>ae-5?n.value=H-h+5:n.value=H+v,A+k>R-5?s.value=R-k:s.value=A+5}}),N=(o,r,d,v)=>o.map(i=>(i.children&&(i.children=N(i.children,r,d,v)),i.label&&typeof i.label=="function"&&(i.label=i.label(v,r,d)),i.tips&&typeof i.tips=="function"&&(i.tips=i.tips(v,r,d)),i.icon&&typeof i.icon=="function"&&(i.icon=i.icon(v,r,d)),i.hidden&&typeof i.hidden=="function"&&(i.hidden=i.hidden(v,r,d)),i.disabled&&typeof i.disabled=="function"&&(i.disabled=i.disabled(v,r,d)),i)),ne=(o=0,r=0)=>z(this,null,function*(){if(t.value=document.elementFromPoint(o-1,r-1),e.menuHiddenFn?m.value=!e.menuHiddenFn(e.params,t.value,e.el):m.value=!0,!m.value)return;b.value=Q(e.menuList),b.value=N(b.value,t.value,e.el,e.params),yield O();const{innerWidth:d,innerHeight:v}=window,h=S.value.offsetHeight,k=e.menuWidth||200;_.value=o+k+1>d?d-k-5:o+1,y.value=r+h+1>v?v-h-5:r+1}),te=()=>{m.value=!1},x=q(()=>e.useLongPressInMobile&&"ontouchstart"in window?"touchstart":"mousedown"),B=o=>{S.value&&!S.value.contains(o.currentTarget)&&(m.value=!1,document.oncontextmenu=null)};return K(()=>e.injectCloseListener,o=>{o?document.addEventListener(x.value,B):document.removeEventListener(x.value,B)},{immediate:!0}),de(()=>{document.removeEventListener(x.value,B)}),{subLeft:n,subTop:s,hoverFlag:u,menuTop:y,menuLeft:_,showMenu:m,clickDomEl:t,calcMenuList:b,arrowSize:T,hasSubMenu:$,MenuWrapper:S,handleMenuItemClick:X,handleSubMenuItemClick:Z,handleMenuMouseEnter:ee,show:ne,close:te,clickEventKey:x}}});const be=["onMouseenter"],he={key:0,class:"__menu__item-icon"},pe=["innerHTML"],fe={class:"__menu__item-label"},ye={class:"__menu__item-tips"},ge={class:"__menu__item-arrow-after"},we={key:0,class:"__menu__item-icon"},Ce=["innerHTML"],Se={class:"__menu__sub__item-label"},ke={class:"__menu__sub__item-tips"};function Me(e,a,n,s,u,y){return l(),P(me,{to:"body",disabled:!e.appendToBody},[e.showMenu?(l(),c("div",{key:0,ref:"MenuWrapper",class:W(["__menu__wrapper",e.customClass]),style:E({width:`${e.menuWidth}px`,top:`${e.menuTop}px`,left:`${e.menuLeft}px`})},[(l(!0),c(L,null,V(e.calcMenuList,(_,m)=>(l(),c(L,null,[!_.hidden&&!_.line?(l(),c("div",U({key:m,class:["__menu__item",_.disabled&&"disabled",_.customClass]},{[J(e.clickEventKey)]:G(t=>e.handleMenuItemClick(_,t),["stop"])},{onMouseenter:t=>e.handleMenuMouseEnter(t,_)}),[e.hasIcon?(l(),c("div",he,[e.iconType==="font-icon"?w((l(),c("i",{key:0,class:W(_.icon)},null,2)),[[C,_.icon]]):e.iconType==="svg-icon"?w((l(),c("div",{key:1,class:"__menu__item-icon-svg",innerHTML:_.icon},null,8,pe)),[[C,_.icon]]):e.iconType==="vnode-icon"?(l(),P(Y(_.icon),{key:2})):p("v-if",!0)])):p("v-if",!0),M("span",fe,F(_.label),1),M("span",ye,F(_.tips||""),1),e.hasSubMenu?(l(),c("span",{key:1,class:W(["__menu__item-arrow",{show:e.hasSubMenu&&_.children}]),style:E({width:e.arrowSize+"px",height:e.arrowSize+"px"})},[w(M("span",ge,null,512),[[C,e.hasSubMenu&&_.children]])],6)):p("v-if",!0),_.children&&_.children.length>0?w((l(),c("div",{key:2,class:"__menu__sub__wrapper",style:E({width:`${e.menuWidth}px`,top:`${e.subTop}px`,left:`${e.subLeft}px`})},[(l(!0),c(L,null,V(_.children,(t,b)=>(l(),c(L,null,[!t.hidden&&!t.line?(l(),c("div",U({key:b,class:["__menu__sub__item",t.disabled&&"disabled",t.customClass]},{[J(e.clickEventKey)]:G($=>e.handleSubMenuItemClick(t,$),["stop"])}),[e.hasIcon?(l(),c("div",we,[e.iconType==="font-icon"?w((l(),c("i",{key:0,class:W(t.icon)},null,2)),[[C,t.icon]]):e.iconType==="svg-icon"?w((l(),c("div",{key:1,class:"__menu__item-icon-svg",innerHTML:t.icon},null,8,Ce)),[[C,t.icon]]):e.iconType==="vnode-icon"?(l(),P(Y(t.icon),{key:2})):p("v-if",!0)])):p("v-if",!0),M("span",Se,F(t.label),1),M("span",ke,F(t.tips||""),1)],16)):p("v-if",!0),t.line?(l(),c("div",{key:b,class:"__menu__line"})):p("v-if",!0)],64))),256))],4)),[[C,e.hoverFlag]]):p("v-if",!0)],16,be)):p("v-if",!0),!_.hidden&&_.line?(l(),c("div",{key:m,class:"__menu__line"})):p("v-if",!0)],64))),256))],6)):p("v-if",!0)],8,["disabled"])}function Te(e,a){a===void 0&&(a={});var n=a.insertAt;if(typeof document!="undefined"){var s=document.head||document.getElementsByTagName("head")[0],u=document.createElement("style");u.type="text/css",n==="top"&&s.firstChild?s.insertBefore(u,s.firstChild):s.appendChild(u),u.styleSheet?u.styleSheet.cssText=e:u.appendChild(document.createTextNode(e))}}var xe=`.__menu__mask[data-v-3d21bc0a] {
  position: fixed;
  top: 0;
  left: 0;
  bottom: 0;
